...
<h2><a class="m-sales m" href="#sales">Sales & Marketing</a></h2>
</li>
...
<tr style="height:0px;"><td style="position:relative;"> <div id="menupointer" style="position:absolute;bottom:-4px;z-index:800;"><img src="../Images/pointer-1.png"/></div></td></tr></table>
			...
			<div id="menufloat" class="footer" style="background:#fff;position:absolute;z-index:206;top:100px;box-shadow: 2px 2px 2px #000;display:none;width:100%;opacity:0.8;filter:alpha(opacity=80)"><div class="colwrap"><div class="inner"><div id="topmenu" style="position:relative;height:15px;width:1200px;"></div></div></div></div></div>
             
                 <!-- main content wrapper -->
			 <div id="main_wrapper">
	<div id="videop" style="display:none;"><video id="vidplayer" width="100" height="100" poster="" controls>Your browser does not support HTML5 Video.</video></div>
...
<div style="height:2px;background:#888"></div>
					 <!-- column 01 visual -->
<div rel="1-top" class="mbg" id="1-main" style="height:600px;position:relative;"><div class="colwrap"><div class="inner"><table class="mntable"><tr><td style="width:20px;"></td><td style="vertical-align:top;" class="txtholder"><h2 style="margin-bottom:5px">The new way to work together</h2><div id="videomn"><video id="videomain" width="675" height="410" poster="../Images/vision_poster.png" controls>Your browser does not support HTML5 Video.</video></div></td><td class="icholder"><div style="height:138px;position:relative;"><div id="favmain" style="position:absolute;bottom:15px;left:45px;font-size:30px;font-weight:lighter;font-family: 'wf_SegoeUILight','wf_SegoeUI','Segoe UI Light','Segoe WP Light','Segoe UI','Segoe','Segoe WP','Tahoma','Verdana','Arial','sans-serif';"><a id="fav" style="color:#444;" class="on" href="#">Favorites</a><a style="color:#999;padding-left:30px;" class="off" id="rec" href="#">Recommended</a><img style="position:absolute;bottom:-12px;padding-left:100px;" id="nextfav1" class="fav" rel="0" src="../Images/next.png"/></div></div><div class="pages-holder">
                <section ID="homepage" class="page-homepage current-page page">
                    <div id="favholder" style="height:340px;"class="row-fluid">
                    </div>
                </section>
				<div>&nbsp;&nbsp;&nbsp;<ul><li class="fl"><div style="margin-right:20px;" class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=301522"><ul><li>Get the Use Case Catalog</li></ul></div></li><li class="fl"><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=301524"><ul><li>Get the Adoption Kit</li></ul></div></li></ul></div>
             </div>
...
<div class="whitebg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/1.3.png"/><img style="position:relative;cursor:pointer;" rel="3" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-88d0a619-1b37-4b62-b5c6-f7b412ee73a9/Module%201%20-%20Demo%203.mp4?sv=2012-02-12&st=2013-05-24T19%3A21%3A53Z&se=2015-05-24T19%3A21%3A53Z&sr=c&si=0adeddf7-5e69-40ea-9354-94b92bb5ba2e&sig=Qe1Lt8wsq47XRPeAje5bXFqZSb7HQldP1axobF%2FO0AU%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Use newsfeeds to share content, connect with people, and stay up to date with what’s going on in your organization.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302013"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		 ...
		 <div id="on_the_same_page" rel="2" class="column_content clearfix c_2">
		 
		<!-- Keep everyone on the same page -->
		<div class="samepage bar"><div class="contentstretch samepage"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Keep everyone on the same page</div><p class="white mntext">Wouldn’t it be great if you and your team had a single place where you could get work done together and stay in sync with each other? SharePoint is exactly that kind of place. It’s a home base where you and your team can share and organize your resources—like notes, documents, schedules, conversations, and much more. No more running around to find what you need or get people what they need. Just go to your team site to get what you want, and then share your stuff instantly with the whole group.</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguide white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></div></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:480px" src="../Images/2tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
		
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">Our research shows that we can increase our productivity up to 25 percent by using social collaboration in the enterprise.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Head of Content Management</h3><p class="blue tb">-Finance Services, Banking</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
...
<div class="whitebg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/2.3.png"/><img style="position:relative;cursor:pointer;" rel="6" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-d96a368f-d683-4510-8a26-db7f81b12c43/Module%202%20-%20Demo%203.mp4?sv=2012-02-12&st=2013-05-24T19%3A22%3A02Z&se=2015-05-24T19%3A22%3A02Z&sr=c&si=0e6044d8-9cd5-4f25-a4af-56a8825f70fa&sig=dx9PP0ft3BRexUDun5KVCk2UvCGlbDaBUHohlxe6nGY%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Share important information with the people you need through shared mailboxes and calendars that help you stay in sync and up to date.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302016"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		...
		<div id="stay_on_track" rel="3" class="column_content clearfix c_3">
		
		<div class="ontrack bar"><div class="contentstretch ontrack"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Stay on track and deliver on time</div><p class="mntext white">Isn't life grand - when all your projects are on track and you meet all your deadlines? SharePoint can make your life a lot easier by helping you organize teamwork around common milestones. You can make sure work gets done by assigning people tasks that can be tracked and prioritized. And, you can keep an eye on important details with a real - time summary of your project that warns you about delays and keeps next steps and milestones on your radar. When it comes to really big and complicated projects, you can use Project Professional to manage task dependencies, balance resource allocations, and easily generate status reports. No need to worry - this all stays in sync with your site, where you can all continue to work together to keep your project on track.</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguide white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:480px" src="../Images/3tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
		
		
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">Project in combination with SharePoint; I think you have a very powerful tool there.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Dr. Christian Buddendick</h3><p class="blue tb">-Head of Workplace Platform Services, Hilti Corporation</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
...
<div class="whitebg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/3.3.png"/><img style="position:relative;cursor:pointer;" rel="9" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-f0269dfb-8b39-4a18-9141-65acb79b5463/Module%203%20-%20Demo%203.mp4?sv=2012-02-12&st=2013-05-24T19%3A21%3A32Z&se=2015-05-24T19%3A21%3A32Z&sr=c&si=ba3bb62e-1b9c-458e-8bb5-f573f8d839f7&sig=YfEu6FPnzD0Hi1bUMqp3Att%2FHMO7pJMQM9wmtHjzM6Y%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Stay on top of things by keeping an eye on all of your personal and assigned tasks in a single to-do list.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302019"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		...
		<div id="connect_with_experts" rel="4" class="column_content clearfix c_4" >
		
		<!-- Connect with experts -->
		<div class="experts bar"><div class="contentstretch experts"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Find the right people</div><p class="white mntext">Things always seem to work out better when you find the right people for the job. The problem is: how do you find the right people without wasting lots of time tracking them down? SharePoint solves this problem. It gives you a single place to connect with experts across your organization, whether they’re in the office down the hall or on the other side of the globe. Now, you can quickly get the answers and information you need to make the right decisions, avoid reinventing the wheel, and improve your work.</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguide white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:4800px" src="../Images/4tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
	
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">With the improvements in SharePoint 2013, we can identify experts anywhere in the world who are best qualified to meet client expectations.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Senior Manager</h3><p class="blue tb">-Business Technology, US Management Consulting Firm</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
		<!-- use case-->
...
<div class="whitebg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/5.3.png"/><img style="position:relative;cursor:pointer;" rel="15" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-968fa31c-d54d-48d0-b97d-f941454bd6d5/Module%205%20-%20Demo%203.mp4?sv=2012-02-12&st=2013-05-24T19%3A21%3A38Z&se=2015-05-24T19%3A21%3A38Z&sr=c&si=4d54ae04-ae5d-4576-8f7c-5ebcceb6e322&sig=rwt%2FOxVKVdVMTnMDDBwOV1SJmkrapuK65j4GgnkX2lw%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Search for video content just as easily as any other type of content, and quickly dig deeper on the results to find exactly what you need.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302025"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		...
		<div class="betterdecisions bar"><div class="contentstretch betterdecisions"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Make informed decisions</div><p class="white mntext">Making good decisions is not always just about good judgment or experience. It’s also about collecting and making sense of lots of data. That’s where PowerPivot comes in: it lets you easily combine massive amounts of data from multiple sources and build sophisticated models out of it. But data alone isn’t enough—it needs to be expressed clearly to make a powerful impact on people. That’s what Power View is for. It lets you explore, visualize, and present data in compelling ways, and create exciting dashboards that you can quickly share with others in SharePoint. Now people can easily dig into your data to make great decisions and new discoveries.</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguide white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:4800px" src="../Images/6tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
	
<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">PowerView allows executives and employees to look at their data from almost any angle at varying levels of granularity. Employees can use scorecards to easily track both time and performance metrics to be more effective in their jobs.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;"> Paul Di Felice</h3><p class="blue tb">-Associate Director for Consulting and Analysis, Regional Municipality of Niagara</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
		<!-- use case-->
		
		<div class="whitebg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/6.1.png"/><img style="position:relative;cursor:pointer;" rel="16" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-b5982b8e-66df-47c8-b03b-20026486a4d3/Module%206%20-%20Demo%203.mp4?sv=2012-02-12&st=2013-05-24T19%3A21%3A28Z&se=2015-05-24T19%3A21%3A28Z&sr=c&si=504eb8ee-9e34-4099-94f1-713cc2d19bb1&sig=DaAwwf07rjkSvxQLHi8VGDjCqqodWLe%2BZZvS4RRqwrA%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Whip up a stunning dashboard with Power View so that you can visualize and share your insights with everyone you need to in SharePoint.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302026
"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		
		<div class="darkgraybg bar"><div style="border-top: 1px solid #cccccc;" class="contentstretch darkgraybg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/6.2.png"/><img style="position:relative;cursor:pointer;" rel="17" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-b063e080-0a89-4e89-a403-8dbd59d30699/Module%206%20-%20Demo%201.mp4?sv=2012-02-12&st=2013-05-24T19%3A21%3A34Z&se=2015-05-24T19%3A21%3A34Z&sr=c&si=1f4caf40-c665-4943-bf79-11b83924df51&sig=HlVR9JReWcMhVOx3D0BMLAhpOFMcGOa7XUBDPars%2FW8%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Gain valuable insights into your data with Power View so that you can ultimately make better decisions for your organization.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302027"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>

<div class="whitebg bar"><div class="contentstretch whitebg"></div><div style="height:45px;"></div><div class="colwrap"><div class="inner"><table><tr><td class="cleft" style="width:582px;height:327px;position:relative;text-align:center;"><img class="cleft im" style="position:absolute;border: 1px solid #cccccc;" src="../Videos/6.3.png"/><img style="position:relative;cursor:pointer;" rel="18" id="https://mediasvc08rg9b3g5vnth.blob.core.windows.net/asset-eb6579e1-7288-43c6-b2a2-3166d21992ca/Module%206%20-%20Demo%202.mp4?sv=2012-02-12&st=2013-05-24T19%3A27%3A28Z&se=2015-05-24T19%3A27%3A28Z&sr=c&si=80382c76-cf96-4daf-b20f-1480a52da7e5&sig=urCi5Sqg3tK9Rs0T5akwFcUIAf4ZQej%2FQeyt3snfx9Q%3D" class="videolnk cleft" src="../Images/playbtn.png"/></td><td style="width:42px;"></td><td style="vertical-align:top;" class="cright" style="width:560px;"><div class="hd">Create a powerful data model from all of your relevant data sources with PowerPivot.</div><div style="height:35px;"></div><div class="dlbuttonm reg" rel="http://go.microsoft.com/fwlink/p/?LinkId=302028"><ul><li>Download video</li></ul></div></td></tr></table><div style="height:60px;"></div></div></div></div>
		...
		<div class="onboarding bar"><div class="contentstretch onboarding"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Onboard new employees</div><p class="white mntext">First days are stressful—for both new employees and the HR department. There’s a lot to learn and a lot to tell. Where do you begin? SharePoint can be the single hub for everything that a new hire needs on its first day, and beyond. You can make it easier for people to connect with their peers or mentors, understand the business, and ramp up rapidly. You can take advantage of automatic task routing and use forms built right into your site, leading to less paperwork and faster completion. Better processes, less time, smoother onboarding. What’s there to stress about?</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguideh white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:4800px" src="../Images/9tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
		
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">Electronic records not only reduce paper consumption, they also save on transportation and energy costs for moving and storing those records.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Steve Folkerts</h3><p class="blue tb">-Project Manager for ECM, Regional Municipality of Niagara</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
		
		<!-- use case-->
		<div class="whitebg bar"><div class="contentstretch whitebg"></div><div class="colwrap"><div style="width:100%;background:#fff;text-align:center;"><img src="../Images/comingsoon.png"/></div></div></div>
...
<!-- Improve and monitor business processes -->
		...
		<div id="engage_your_audience" rel="12" class="column_content clearfix c_12" >
		
		<!-- Engage your audience online -->
		<div class="buildonline bar"><div class="contentstretch buildonline"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Engage your audience online</div><p class="white mntext">People expect the same experience no matter how they access your site. To make sure they get it, SharePoint makes it possible for you to deliver a consistent, unified digital experience on laptops, smartphones, and tablets. Not only are your SharePoint sites accessible from any device, but they also deliver targeted, highly relevant content and personalized recommendations to your audience around the globe. Building a global brand is now easier than ever, and SharePoint also helps you stay in compliance with copyright and other legal requirements by ensuring consistency across all of your sites. </p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguideh white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:4800px" src="../Images/14tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
		
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">SharePoint has enhanced our mobile publishing capabilities. And it adds public catalog capabilities to implement one global product catalog for a specific brand and we can use that through various sites.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Alex Alexandrou</h3><p class="blue tb">-Vice President of Global IS, Web Technology, D+M Group</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
...
<!--INFORMATION TECHNOLOGY  wrapper -->
	...
	<!-- Provide the right support -->
		...
		<div class="whitebg bar"><div class="contentstretch whitebg"></div><div class="colwrap"><div style="width:100%;background:#fff;text-align:center;"><img src="../Images/comingsoon.png"/></div></div></div>
			...
			<div id="empower_people" rel="17" class="column_content clearfix c_17" >	 
				 
		<!-- Empower people and stay in control -->
		<div class="empowerpeople bar"><div class="contentstretch empowerpeople"></div><div class="colwrap"><div class="inner"><table class="mntable"><tr><td class="cleft" style="width:582px;vertical-align:top;"><div style="height:50px;position:relative;"><div class="icons"></div></div><div class="rtext"><div class="textcont"><div class="white htext">Empower people and stay in control</div><p class="white mntext">It’s a common dilemma: How do you strike a balance between the needs of IT and the needs of users? IT needs centralized control over security and compliance to better manage risks. People want more flexibility in SharePoint to work together. So who’s right? With SharePoint, everyone’s right. IT can make SharePoint more open and provide a safety net so that people’s sites comply with IT controls, permissions, and policies. It’s a win-win situation.</p></div></div><table><tr><td><div class="more white" style="display:none;"><div style="height:6px;"></div><div class="hide"></div><div class="rtoggle"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Show more</div></div></td><td><div style="height:6px;"></div><div class="gguideh white"><img src="../Images/down-white.png"/>&nbsp;&nbsp;Get the Guide</div></td></tr></table></td><td class="cmid" style="width:120px"></td><td style="vertical-align:middle;"><div style="height:50px;"></div><img class="ucimage" style="width:4800px" src="../Images/8tall_img.png"/></td></tr></table><div style="height:50px;position:relative;"></div></div></div></div>
		
		<!-- testimonial-->
		<div class="darkgraybg bar"><div class="contentstretch darkgraybg"></div><div style="height:20px;"></div><div class="colwrap"><div class="inner"><table><tr><td style="vertical-align:top;"><img src="../Images/quotes.png"/></td><td style="width:980px";><p class="black tq">Site creation is automated, and we assign metadata at the site level, rather than the document level, so it's easier to use. The system integrates with our records management workflows, so documents are automatically retained and disposed of according to mandated schedules.</p></td><td style="vertical-align:bottom;"><img src="../Images/quotes2.png"/></td></tr><tr><td></td><td><div style="position:relative;"><div style="position:absolute;top:20px;"><img src="../Images/testimonial_person.png"/></div><div style="position:absolute;left:70px;"><h3 style="margin-top:35px;margin-bottom:10px;">Steve Folkerts</h3><p class="blue tb">- Project Manager for ECM, Regional Municipality of Niagara</p></div></div></td><td></td></tr></table></div></div><div style="height:105px;"></div></div>
		<!-- use case-->
...
<div class="darkbluebg" style="height:70px"></div>
		...
		<div class="whitebg" style="height:400px;position:relative;border:"><div class="colwrap"><div class="inner"><table><tr><td class="txtholder" style="vertical-align:top;"><p>Feature your the best use cases for your business. They could be random, or how you want your employees to view the site and learn about Sharepoint. Make the use cases most relevant to your company really stand out.</p><table><tr><td><img style="padding:10px;" src="../Images/admin_hidebig.png"/></td><td class="ptext" style="width:100%;vertical-align:middle;">Not interested in your team learning about this feature? Click the "eye" icon to hide it from the site.</td></tr><tr><td><img style="padding:10px;" src="../Images/admin_checkedbig.png"/></td><td class="ptext" style="width:100%;vertical-align:middle;">Recommmend sections for your team to look at.</td></tr></table></td><td class="icholder"><div style="position:relative;"><img style="position:absolute;top:-20px;right:0px;" id="nextfav2" rel="0" src="../Images/next.png"/></div><div class="pages-holder">
